...
class UserSerializer(serializers.ModelSerializer):
    """Serializer cho User (public info)"""
    
    class Meta:
        model = User
        fields = [
            'id', 'email', 'username', 'full_name',
            'affiliation', 'country', 'bio', 'website',
            'orcid', 'avatar', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']


class UserDetailSerializer(serializers.ModelSerializer):
    """Serializer chi tiết cho User (private info)"""
    ...
    class Meta:
        ...
        fields = [
            ...
            'country', 'bio', 'phone_number', 'website',
            'orcid', 'avatar', 'status', 'email_verified',
...
class UserConferenceRoleSerializer(serializers.ModelSerializer):
    """Serializer cho UserConferenceRole"""
    ...
    class Meta:
        ...
        fields = [
            'user_role_id', 'user', 'user_email', 'user_name',
            'conference', 'conference_name', 'role', 'role_name',
...
class UserNotificationPreferenceSerializer(serializers.ModelSerializer):
    """Serializer cho Notification Preferences"""
